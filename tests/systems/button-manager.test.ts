...
describe("UIButtonManager", () => {
    ...
    describe("Initialization", () => {
        ...
        test("should warn when not initialized", () => {
            ...
            expect(warnSpy).toHaveBeenCalledWith("[⚠️ WARN][ButtonManager]", "UIButtonManager not initialized");
            warnSpy.mockRestore();
        });
    ...
    describe("Cleanup and Destroy", () => {
        ...
        test("should warn when cleanup called without initialization", () => {
            ...
            expect(warnSpy).toHaveBeenCalledWith("[⚠️ WARN][ButtonManager]", "ButtonManager not initialized");
            warnSpy.mockRestore();
        });
    ...
    describe("Edge Cases", () => {
        ...
        test("should warn when showing a button that is already visible", () => {
            ...
            expect(result).toBe(false);
            expect(warnSpy).toHaveBeenCalledWith("[⚠️ WARN][ButtonManager]", 'Button "btn1" already visible');
            warnSpy.mockRestore();
        });
        ...
        test("should warn when hiding a non-existent button", () => {
            ...
            expect(result).toBe(false);
            expect(warnSpy).toHaveBeenCalledWith("[⚠️ WARN][ButtonManager]", 'Button "nonexistent" not found');
            warnSpy.mockRestore();
        });
