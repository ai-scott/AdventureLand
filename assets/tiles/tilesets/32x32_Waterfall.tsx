...
<tileset version="1.10" tiledversion="1.10.2" name="32x32_Waterfall" tilewidth="16" tileheight="16" tilecount="320" columns="16">
 <image source="../Assets/32x32_Waterfall_full.png" width="256" height="320"/>
 <tile id="0">
  <animation>
